...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/05 11:25:51 by seocha            #+#    #+#             */
/*   Updated: 2023/02/23 16:42:07 by seocha           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	y_move_up(t_game *game, int *dir)
{
	*dir = 1;
	...
	{
		if (game->map.arr[game->player.loc - game->map.width] == 'X')
		{
			ft_printf("%s\n", "Game Over!!");
			exit_game(game);
		}
...
void	y_move_left(t_game *game, int *dir)
{
	*dir = 2;
	...
	{
		if (game->map.arr[game->player.loc - 1] == 'X')
		{
			ft_printf("%s\n", "Game Over!!");
			exit_game(game);
		}
